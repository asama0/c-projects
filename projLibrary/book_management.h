...
struct Book {
		...
		char code[25];
		char authors[100]; //comma separated list of authors
		unsigned int year; // year of publication
		unsigned int copies; //number of copies the library has
		unsigned int borrowed_copies;
};

struct BookArray {
	 struct Book array[100]; // pointer to array of struct Book.
...
int book_exists(char *); //Returns the index at which the book is placed with the code provided
